    ...
    return (
        <div className="app-container flex-row">
            ...
            <div className="content flex-grow-1 flex-column-ver-center">
                ...
                <div className="desc">
                    Software Engineer with 6 years of experience in Web
                    Technology - ReactJS, Next.js, Redux Toolkit, React
                    Bootstrap, React Testing Library, Jest, Angular, RxJS,
                    Karma, Jasmine, Sass, Plotly & D3 (Data Visualisation),
